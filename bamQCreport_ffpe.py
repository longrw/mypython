...
def content(fs,info):
    ...
    print "<tr><th>&nbsp;</th><th><b>FFPE/fnadna/pedna/saldna/tisdna</b></th></tr>"
    print "<tr><td><b>Total clean reads</b></td><td>" + info[0] + "</td></tr>"
    print "<tr><td><b>Mapping rate</b></td><td>" + info[1] + "</td></tr>"
    print "<tr><td><b>Duplication rate</b></td><td>" + info[2] + "</td></tr>"
    print "<tr><td><b>Mean depth(raw)</b></td><td>" + info[3] + "</td></tr>"
    print "<tr><td><b>Mean depth(deduplication)</b></td><td>" + info[4] + "</td></tr>"
    print "<tr><td><b>Capture percentage</b></td><td>" + info[6] + "</td></tr>"
    print "<tr><td><b>Capture percentage(deduplication)</b></td><td>" + info[5] + "</td></tr>"
    print "</table>"
    print "</div>"
    for f in fs:
